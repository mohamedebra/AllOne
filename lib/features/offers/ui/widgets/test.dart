...
class _OffersScreenTestState extends State<OffersScreenTest> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) => OffersCubit(OfferRepo(ApiService(Dio())),ProductRepo(ApiService(Dio()))),
    ...
    showPlatformDialog(
      ...
      builder: (BuildContext context) => BasicDialogAlert(
        ...
        content: SizedBox(
          ...
          width: MediaQuery.of(context).size.width,
          child: BlocProvider(
            create: (context) => OffersCubit(OfferRepo(ApiService(Dio())),ProductRepo(ApiService(Dio())))..fetchCountry(),
