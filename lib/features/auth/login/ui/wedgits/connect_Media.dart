...
class ConnectMedia extends StatefulWidget {
  const ConnectMedia({super.key});

  @override
  State<ConnectMedia> createState() => _ConnectMediaState();
}

class _ConnectMediaState extends State<ConnectMedia> {
  ...
  //
  //   // Navigator.of(context).pushNamedAndRemoveUntil(Routes.homeScreen, (Route<dynamic> route) => false);
            ...
            CircleAvatar(
              ...
              child: IconButton(
                  onPressed: () async {
                    ...
                    CacheHelper.savedata(key: 'loginEmail', value: AppleIDAuthorizationScopes.email);
                    CacheHelper.savedata(key: 'loginName', value: AppleIDAuthorizationScopes.fullName);
                    context.pushAndRemoveUntil(Routes.homeScreen, predicate: (route) => false);
